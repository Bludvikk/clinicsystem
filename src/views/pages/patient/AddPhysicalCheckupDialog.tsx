...
const AddPhysicalCheckupDialog: FC<{ id: string }> = ({ id }) => {
  ...
  const diagnosisOnSubmitHandler: SubmitHandler<IDiagnosis> = (
    data: IDiagnosis
  ) => {
    addDiagnosis(data);
    diagnosisReset();
  ...
  const treatmentOnSubmitHandler: SubmitHandler<ITreatment> = (
    data: ITreatment
  ) => {
    addTreatment(data);
    TreatmentReset();
        ...
        <Grid container px={5}>
          ...
          <Grid item xs={12} mt={3}>
            <TabContext value={tabsValue}>
              ...
              <TabPanel value="2">
                <form
                  onSubmit={diagnosisHandleSubmit(diagnosisOnSubmitHandler)}
                >
              ...
              <TabPanel value="3">
                <form
                  onSubmit={treatmentHandleSubmit(treatmentOnSubmitHandler)}
                >
                  <Grid container mt={1} alignItems="center">
                    <Grid item flex={3}>
                      <Controller
                        ...
                        render={({ field }) => (
                          <FormControl fullWidth>
                            <InputLabel id="medicineId-label">
                              Treatment
                            </InputLabel>
                            <Select
                              label="Treatment"
...
const EditDiagnosisDialog: FC<PropsType> = ({ maxWidth }) => {
  ...
  const editDiagnosisOnSubmitHandler: SubmitHandler<IDiagnosis> = (
    data: IDiagnosis
  ) => {
...
const EditTreatmentDialog: FC<PropsType> = ({ maxWidth }) => {
  ...
  const editTreatmentOnSubmitHandler: SubmitHandler<ITreatment> = (
    data: ITreatment
  ) => {
